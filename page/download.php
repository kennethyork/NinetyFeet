...
$expected = hash_hmac('sha256', "$platform|$orderId|$expires", $config['link_secret']);
...
if (time() > $expires)
    refuse("That link has expired. Reply to your PayPal receipt and I'll send a fresh one.", 410);
